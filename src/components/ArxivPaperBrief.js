            ...
            >
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <View style={{ flex: 0, marginRight: 8 }}>
                        {props.isFavourite ? <Ionicons color="#000" size={16} name="star" /> : null}
                    </View>
                </View>
                <Text style={{}}>
                ...
                {props.item.comment ? (
                    <Text style={styles.paperComment}>Comments: {props.item.comment}</Text>
                ) : null}
                <Text style={styles.paperSummary} numberOfLines={8}>
                    {props.item.summary}
                </Text>
            </View>
        </TouchableOpacity>
